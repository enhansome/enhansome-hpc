...
* [XCat](https://xcat.org/) - xCAT is a toolkit for deployment and administration of clusters of all sizes ([Source Code](https://github.com/xcat2/xcat-core) ⭐ 396 | 🐛 246 | 🌐 Perl | 📅 2026-09-02) `EPL-1.0`.
* [BlueBanquise](https://bluebanquise.com) - BlueBanquise is an open source cluster deployment and management stack built on Python and Ansible ([Source Code](https://github.com/bluebanquise/bluebanquise) ⭐ 163 | 🐛 38 | 🌐 Python | 📅 2026-09-03) `MIT`.
...
* [Slurm](https://slurm.schedmd.com/documentation.html) - A free and open source job scheduler ([Source Code](https://github.com/SchedMD/slurm) ⭐ 4,310 | 🐛 15 | 🌐 C | 📅 2026-09-02) `OSS`.
...
* [Pegasus](https://pegasus.isi.edu/) - A configurable system for mapping and executing scientific workflows over a wide range of computational infrastructure ([Source Code](https://github.com/pegasus-isi/pegasus) ⭐ 244 | 🐛 26 | 🌐 Java | 📅 2026-09-03)`Apache-2.0`.
* [Nextflow](https://nextflow.io) - Data drive computational pipelines `Apache-2.0`.

## Applications

* [Spack](https://spack.io) - A flexible package manager that supports multiple versions, configurations, platforms, and compilers ([Source Code](https://github.com/spack/spack) ⭐ 5,117 | 🐛 1,804 | 🌐 Python | 📅 2026-09-03) `other`.
...
* [LLVM](https://llvm.org/) - The LLVM project is a collection of modular compilers and toolchains ([Source Code](https://github.com/llvm/llvm-project) ⭐ 40,067 | 🐛 38,758 | 🌐 LLVM | 📅 2026-09-03) `OSS`.

## MPI

* [OpenMPI](https://www.open-mpi.org/) - OpenMPI is an open source implementation of the MPI-3.1 standard ([Source Code](https://github.com/open-mpi/ompi) ⭐ 2,632 | 🐛 836 | 🌐 C | 📅 2026-09-03) `BSD`.
* [MPICH](https://www.mpich.org/) - MPICH is a high-performance and widely portable implementation of the MPI-3.1 standard ([Source Code](https://github.com/pmodels/mpich) ⭐ 685 | 🐛 302 | 🌐 C | 📅 2026-09-02) `other`.
...
* [elbencho](https://github.com/breuner/elbencho) ⭐ 287 | 🐛 8 | 🌐 C++ | 📅 2026-09-02 - A distributed storage benchmark for files, objects & blocks with support for GPUs `GPL-3`.
...
* [Coldfront](https://coldfront.readthedocs.io/en/latest/) - ColdFront is an open source resource allocation system designed to provide a central portal for administration, reporting, and measuring scientific impact of HPC resources ([Source Code](https://github.com/ubccr/coldfront) ⭐ 161 | 🐛 113 | 🌐 Python | 📅 2026-09-03) `GPL-3`.
...
* [Mamba](https://mamba.readthedocs.io/en/latest/) - Mamba is a reimplementation of the conda package manager in C++ ([Source Code](https://github.com/mamba-org/mamba) ⭐ 8,086 | 🐛 465 | 🌐 C++ | 📅 2026-08-25) `BSD`.
...
* [Paraview](https://www.paraview.org/) - ParaView is an open-source, multi-platform data analysis and visualization application based on Visualization Toolkit (VTK) ([Source Code](https://github.com/Kitware/ParaView) ⭐ 1,689 | 🐛 8 | 🌐 C++ | 📅 2026-09-03) `BSD-3`.
* [Visit](https://visit-dav.github.io/visit-website/) - VisIt - Visualization and Data Analysis for Mesh-based Scientific Data ([Source Code](https://github.com/visit-dav/visit) ⭐ 531 | 🐛 1,937 | 🌐 C | 📅 2026-09-03) `BSD-3`.

## Parallel Filesystems

* [Ceph](https://ceph.io/en/) - Ceph is a distributed object, block, and file storage platform ([Source Code](https://github.com/ceph/ceph) ⭐ 17,001 | 🐛 1,318 | 🌐 C++ | 📅 2026-09-03) `other`.
