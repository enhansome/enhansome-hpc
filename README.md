...
* [Cobbler](https://cobbler.github.io/) - Cobbler is a Linux installation server that allows for rapid setup of network installation environments ([Source Code](https://github.com/cobbler/cobbler) ⭐ 2,773 | 🐛 306 | 🌐 Python | 📅 2026-09-17) `GPL-2.0`.
* [Warewulf](https://warewulf.hpcng.org/) - Warewulf is a stateless and diskless container operating system provisioning system for large clusters of bare metal and/or virtual systems ([Source Code](https://github.com/hpcng/warewulf) ⭐ 662 | 🐛 264 | 🌐 Go | 📅 2026-09-16) `BSD-3`.
* [XCat](https://xcat.org/) - xCAT is a toolkit for deployment and administration of clusters of all sizes ([Source Code](https://github.com/xcat2/xcat-core) ⭐ 397 | 🐛 252 | 🌐 Perl | 📅 2026-09-17) `EPL-1.0`.
...
* [Slurm](https://slurm.schedmd.com/documentation.html) - A free and open source job scheduler ([Source Code](https://github.com/SchedMD/slurm) ⭐ 4,366 | 🐛 19 | 🌐 C | 📅 2026-09-17) `OSS`.
...
* [Cromwell](https://cromwell.readthedocs.io/en/stable/) - Scientific workflow engine designed for simplicity & scalability ([Source Code](https://github.com/broadinstitute/cromwell) ⭐ 1,082 | 🐛 814 | 🌐 Scala | 📅 2026-09-15) `BSD-3`.
* [Pegasus](https://pegasus.isi.edu/) - A configurable system for mapping and executing scientific workflows over a wide range of computational infrastructure ([Source Code](https://github.com/pegasus-isi/pegasus) ⭐ 246 | 🐛 26 | 🌐 Java | 📅 2026-09-17)`Apache-2.0`.
* [Nextflow](https://nextflow.io) - Data drive computational pipelines `Apache-2.0`.

## Applications

* [Spack](https://spack.io) - A flexible package manager that supports multiple versions, configurations, platforms, and compilers ([Source Code](https://github.com/spack/spack) ⭐ 5,125 | 🐛 1,805 | 🌐 Python | 📅 2026-09-17) `other`.
...
* [LLVM](https://llvm.org/) - The LLVM project is a collection of modular compilers and toolchains ([Source Code](https://github.com/llvm/llvm-project) ⭐ 40,516 | 🐛 39,195 | 🌐 LLVM | 📅 2026-09-17) `OSS`.

## MPI

* [OpenMPI](https://www.open-mpi.org/) - OpenMPI is an open source implementation of the MPI-3.1 standard ([Source Code](https://github.com/open-mpi/ompi) ⭐ 2,644 | 🐛 844 | 🌐 C | 📅 2026-09-16) `BSD`.
* [MPICH](https://www.mpich.org/) - MPICH is a high-performance and widely portable implementation of the MPI-3.1 standard ([Source Code](https://github.com/pmodels/mpich) ⭐ 686 | 🐛 299 | 🌐 C | 📅 2026-09-16) `other`.
...
* [HPCC Systems](https://hpccsystems.com/) - HPCC Systems (High Performance Computing Cluster) is an open source, massive parallel-processing computing platform for big data processing and analytics ([Source Code](https://github.com/hpcc-systems/HPCC-Platform) ⭐ 616 | 🐛 481 | 🌐 C++ | 📅 2026-09-10) `other`.
* [elbencho](https://github.com/breuner/elbencho) ⭐ 292 | 🐛 8 | 🌐 C++ | 📅 2026-09-17 - A distributed storage benchmark for files, objects & blocks with support for GPUs `GPL-3`.
...
* [Open XDMod](https://open.xdmod.org) - Open XDMoD is an open source tool to facilitate the management of high performance computing resources ([Source Code](https://github.com/ubccr/xdmod/) ⭐ 105 | 🐛 32 | 🌐 PHP | 📅 2026-09-15) `LGPL-3`.
...
* [OLCF Test Harness](https://olcf.github.io/olcf-test-harness/) - The OLCF Test Harness (OTH) helps automate the testing of applications, tools, and other system software ([Source Code](https://github.com/olcf/olcf-test-harness) ⭐ 14 | 🐛 43 | 🌐 Python | 📅 2026-09-10) `other`.
...
* [pdsh](https://linux.die.net/man/1/pdsh) - pdsh runs terminal commands across multiple hosts in parallel ([Source Code](https://github.com/chaos/pdsh) ⭐ 568 | 🐛 44 | 🌐 C | 📅 2026-01-12) `GPL-2`.
...
* [Apptainer](https://apptainer.org) - Apptainer is an open source container system ([Source Code](https://github.com/apptainer/apptainer) ⭐ 1,965 | 🐛 203 | 🌐 Go | 📅 2026-09-16) `BSD`.
...
* [Mamba](https://mamba.readthedocs.io/en/latest/) - Mamba is a reimplementation of the conda package manager in C++ ([Source Code](https://github.com/mamba-org/mamba) ⭐ 8,097 | 🐛 460 | 🌐 C++ | 📅 2026-09-16) `BSD`.
* [Environment Modules](https://modules.readthedocs.io/en/latest/) - Environment Modules: provides dynamic modification of a user's environment  ([Source Code](https://github.com/cea-hpc/modules) ⭐ 866 | 🐛 32 | 🌐 Tcl | 📅 2026-09-09) `GPL-2`.
...
* [Paraview](https://www.paraview.org/) - ParaView is an open-source, multi-platform data analysis and visualization application based on Visualization Toolkit (VTK) ([Source Code](https://github.com/Kitware/ParaView) ⭐ 1,700 | 🐛 8 | 🌐 C++ | 📅 2026-09-17) `BSD-3`.
...
* [Ceph](https://ceph.io/en/) - Ceph is a distributed object, block, and file storage platform ([Source Code](https://github.com/ceph/ceph) ⭐ 17,049 | 🐛 1,438 | 🌐 C++ | 📅 2026-09-17) `other`.
...
* [DCGM Exporter](https://github.com/NVIDIA/dcgm-exporter) ⭐ 1,872 | 🐛 165 | 🌐 Go | 📅 2026-09-10 - NVIDIA GPU metrics exporter for Prometheus leveraging DCGM `Apache-2.0`.
