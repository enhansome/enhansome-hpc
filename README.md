...
* [Pegasus](https://pegasus.isi.edu/) - A configurable system for mapping and executing scientific workflows over a wide range of computational infrastructure ([Source Code](https://github.com/pegasus-isi/pegasus) ⭐ 242 | 🐛 22 | 🌐 Java | 📅 2026-08-19)`Apache-2.0`.
...
* [OpenMPI](https://www.open-mpi.org/) - OpenMPI is an open source implementation of the MPI-3.1 standard ([Source Code](https://github.com/open-mpi/ompi) ⭐ 2,633 | 🐛 818 | 🌐 C | 📅 2026-08-18) `BSD`.
* [MPICH](https://www.mpich.org/) - MPICH is a high-performance and widely portable implementation of the MPI-3.1 standard ([Source Code](https://github.com/pmodels/mpich) ⭐ 685 | 🐛 297 | 🌐 C | 📅 2026-08-17) `other`.
...
* [Pavilion2](https://pavilion2.readthedocs.io/) - Pavilion is a Python 3 (3.6+) based framework for running and analyzing tests targeting HPC systems ([Source Code](https://github.com/hpc/pavilion2) ⭐ 46 | 🐛 237 | 🌐 Python | 📅 2026-08-18) `other`.
...
* [Paraview](https://www.paraview.org/) - ParaView is an open-source, multi-platform data analysis and visualization application based on Visualization Toolkit (VTK) ([Source Code](https://github.com/Kitware/ParaView) ⭐ 1,684 | 🐛 8 | 🌐 C++ | 📅 2026-08-19) `BSD-3`.
* [Visit](https://visit-dav.github.io/visit-website/) - VisIt - Visualization and Data Analysis for Mesh-based Scientific Data ([Source Code](https://github.com/visit-dav/visit) ⭐ 531 | 🐛 1,941 | 🌐 C | 📅 2026-08-19) `BSD-3`.
...
* [DCGM Exporter](https://github.com/NVIDIA/dcgm-exporter) ⭐ 1,835 | 🐛 182 | 🌐 Go | 📅 2026-08-19 - NVIDIA GPU metrics exporter for Prometheus leveraging DCGM `Apache-2.0`.
