...
* [Cobbler](https://cobbler.github.io/) - Cobbler is a Linux installation server that allows for rapid setup of network installation environments ([Source Code](https://github.com/cobbler/cobbler) ⭐ 2,767 | 🐛 306 | 🌐 Python | 📅 2026-08-31) `GPL-2.0`.
...
* [XCat](https://xcat.org/) - xCAT is a toolkit for deployment and administration of clusters of all sizes ([Source Code](https://github.com/xcat2/xcat-core) ⭐ 396 | 🐛 251 | 🌐 Perl | 📅 2026-08-31) `EPL-1.0`.
...
* [Slurm](https://slurm.schedmd.com/documentation.html) - A free and open source job scheduler ([Source Code](https://github.com/SchedMD/slurm) ⭐ 4,295 | 🐛 14 | 🌐 C | 📅 2026-08-31) `OSS`.
...
* [Cromwell](https://cromwell.readthedocs.io/en/stable/) - Scientific workflow engine designed for simplicity & scalability ([Source Code](https://github.com/broadinstitute/cromwell) ⭐ 1,080 | 🐛 814 | 🌐 Scala | 📅 2026-08-31) `BSD-3`.
* [Pegasus](https://pegasus.isi.edu/) - A configurable system for mapping and executing scientific workflows over a wide range of computational infrastructure ([Source Code](https://github.com/pegasus-isi/pegasus) ⭐ 243 | 🐛 26 | 🌐 Java | 📅 2026-08-30)`Apache-2.0`.
* [Nextflow](https://nextflow.io) - Data drive computational pipelines `Apache-2.0`.

## Applications

* [Spack](https://spack.io) - A flexible package manager that supports multiple versions, configurations, platforms, and compilers ([Source Code](https://github.com/spack/spack) ⭐ 5,116 | 🐛 1,804 | 🌐 Python | 📅 2026-08-31) `other`.
...
* [LLVM](https://llvm.org/) - The LLVM project is a collection of modular compilers and toolchains ([Source Code](https://github.com/llvm/llvm-project) ⭐ 40,023 | 🐛 38,664 | 🌐 LLVM | 📅 2026-08-31) `OSS`.
...
* [HPCC Systems](https://hpccsystems.com/) - HPCC Systems (High Performance Computing Cluster) is an open source, massive parallel-processing computing platform for big data processing and analytics ([Source Code](https://github.com/hpcc-systems/HPCC-Platform) ⭐ 614 | 🐛 480 | 🌐 C++ | 📅 2026-08-31) `other`.
* [elbencho](https://github.com/breuner/elbencho) ⭐ 285 | 🐛 11 | 🌐 C++ | 📅 2026-08-30 - A distributed storage benchmark for files, objects & blocks with support for GPUs `GPL-3`.
...
* [Coldfront](https://coldfront.readthedocs.io/en/latest/) - ColdFront is an open source resource allocation system designed to provide a central portal for administration, reporting, and measuring scientific impact of HPC resources ([Source Code](https://github.com/ubccr/coldfront) ⭐ 161 | 🐛 112 | 🌐 Python | 📅 2026-08-25) `GPL-3`.
...
* [ClusterShell](https://clustershell.readthedocs.io/en/latest/intro.html) - Scalable cluster administration Python framework ([Source Code](https://github.com/cea-hpc/clustershell) ⭐ 474 | 🐛 114 | 🌐 Python | 📅 2026-08-30) `LGPL-2.1` .

## Containers

* [Apptainer](https://apptainer.org) - Apptainer is an open source container system ([Source Code](https://github.com/apptainer/apptainer) ⭐ 1,952 | 🐛 193 | 🌐 Go | 📅 2026-08-31) `BSD`.
...
* [Environment Modules](https://modules.readthedocs.io/en/latest/) - Environment Modules: provides dynamic modification of a user's environment  ([Source Code](https://github.com/cea-hpc/modules) ⭐ 864 | 🐛 29 | 🌐 Tcl | 📅 2026-08-31) `GPL-2`.
...
* [Paraview](https://www.paraview.org/) - ParaView is an open-source, multi-platform data analysis and visualization application based on Visualization Toolkit (VTK) ([Source Code](https://github.com/Kitware/ParaView) ⭐ 1,689 | 🐛 8 | 🌐 C++ | 📅 2026-08-31) `BSD-3`.
* [Visit](https://visit-dav.github.io/visit-website/) - VisIt - Visualization and Data Analysis for Mesh-based Scientific Data ([Source Code](https://github.com/visit-dav/visit) ⭐ 531 | 🐛 1,936 | 🌐 C | 📅 2026-08-27) `BSD-3`.

## Parallel Filesystems

* [Ceph](https://ceph.io/en/) - Ceph is a distributed object, block, and file storage platform ([Source Code](https://github.com/ceph/ceph) ⭐ 16,983 | 🐛 1,320 | 🌐 C++ | 📅 2026-08-31) `other`.
...
* [DCGM Exporter](https://github.com/NVIDIA/dcgm-exporter) ⭐ 1,851 | 🐛 185 | 🌐 Go | 📅 2026-08-19 - NVIDIA GPU metrics exporter for Prometheus leveraging DCGM `Apache-2.0`.
